...
public class Ex01_Array_Basic {
	public static void main(String[] args) {
		...
		//각각의 방에 대한 접근은 : 첨자, index로 접근 : 배열의 시작값은 0부터
		...
		//java.lang.ArrayIndxOutOfBoundException
		//자주 봅시다...
		...
		//배열을 만드는 3가지 방법***
		int[] arr1 = new int[5];  // 기본 : 방의 크기
		int[] arr2 = new int[]{100,200,300}; //값을(초기값) 정의해서 배열생성
		...
		//arr4 = {1,2,3}; 선언과 할당을 분리할때는 사용불가 (new 를 써야한다)
		arr4 = new int[] {21,22,23,25,35};
		
		int[] arr5 = arr4; //주소값 할당
		System.out.println(arr4==arr5); //true (같은 주소를 바라보고있다)
