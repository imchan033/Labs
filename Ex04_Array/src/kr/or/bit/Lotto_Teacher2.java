...
//2 값을 입력 >> 화면에 출력.....
//3 값을 입력 >> 종료
public class Lotto_Teacher2 {
    private Scanner scanner;
    private Random r; //r.nextInt(45)+1 (1~45)
    private int[] numbers;
                     //static{}  , {}  초기자
    public Lotto_Teacher2() { //특수한 목적:member field 초기화 :(생성자 함수) , constructor
   ...
   private String showMenu(Scanner scanner) {
       ...
       System.out.println("3. 추가기능)수동3개 입력");
       System.out.println("*********************");
...
escape: while(true) {
           ...
           switch (selectionnum) {
                   case "1": selectBasicLottoNumber(r,numbers); //추출
