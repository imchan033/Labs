/*
 Today Point : [상속관계]에서 override : 상속관계에서의 부모의 메소드 재정의
 -상속관계에서 자식클래스가 부모클래스의 메서드의 재정의
 -재정의 : 함수의 형태는 변화가 없고... 내용만 바뀌는 것
 			형태가 바뀌는것-> overroading ( 상속과는 상관 없다 ) : 하나의 이름으로 여러가지 기능을 하는 것
...
//3개의 점이 필요하다
//이미 2개의 점을 가지고 있는 설계도..
class Point3D extends Point2 {
	int z = 6;

	//ctrl + shift +s -> Override/Implement method...
	@Override
	String getPosition() {
...
public class Ex04_Inherit_override {
	...
	public static void main(String[] args) {
		...
		point.y = 6;
		point.z = 9;
		String result = point.getPosition(); //재정의 하면 재정의된 함수를 출력한다.
